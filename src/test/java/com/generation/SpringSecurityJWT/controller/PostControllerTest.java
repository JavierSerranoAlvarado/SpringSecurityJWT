...
class PostControllerTest {
    ...
    @Test
    @DisplayName("Testando el mockito")
    void testMockito() {
        //mock creation
    ...
    @Test
    @DisplayName("Testando el mockito2")
    void testMockito2() {
    ...
    void postSaveTest() {
        ...
        post.setContent("Pruebas en JUnit con Mockito");

        when(postService.save(any(Post.class))).thenReturn(post);
        Post result = postController.save(post);
        verify(postService, times(2)).save(any(Post.class));
